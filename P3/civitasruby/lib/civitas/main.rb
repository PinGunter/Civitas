...
require_relative "tablero"    # ya incluye casilla
...
module Civitas
  ...
  valor = 6
  texto = "buenas tardes"
  tipo = Estados_juego::DESPUES_AVANZAR

  s1 = Sorpresa.new_tablero(tipo,tablero)
  s2 = Sorpresa.new_tablero_valor_texto(tipo,tablero,valor,texto)
  s3 = Sorpresa.new_valor_texto(tipo,valor,texto)
  s4 = Sorpresa.new_mazo(tipo,mazo)
  ...
  listado = Array.new
  4.times do
    listado << Sorpresa.new_valor_texto(tipo,valor,texto)
  end
