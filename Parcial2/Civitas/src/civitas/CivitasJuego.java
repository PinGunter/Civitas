...
public class CivitasJuego {
    ...
    private void inicializarTablero(MazoSorpresas mazo) {
        tablero.añadeCasilla(new CasillaCalle(new TituloPropiedadHijo("Huerta Los Patos", 100, 0.27f, 300, 300, 300)));
        tablero.añadeCasilla(new CasillaCalle(new TituloPropiedadHijo("Calle Rodahuevo", 200, 0.53f, 300, 300, 300)));
...
//        }
    ...
    // INICIO EXAMEN
    //como dice que muestra por pantalla, en lugar de devolver string directamnte lo muestro en pantalla desde este metodo
    public void verMazo(){
        System.out.println("SORPRESAS:\n");
        for (int i=0; i < mazo.getSorpresas().size(); i++){
            System.out.println(mazo.getSorpresas().get(i));
        }
    }
